...
<body>
    ...
    <?php
    $GelirEklemeSorgu = $DbConnect->prepare("SELECT * FROM ofiice ORDER BY id DESC");
    $GelirEklemeSorgu->execute();
    $GelirEklemeSorguSayisi = $GelirEklemeSorgu->rowCount();
    ...
    <table align="center" style="width: 1065px;" border="2" cellpadding="5">
        <tbody>
            ...
            <form action="EkleSonuc.php" method="POST">
                <tr align="center">
